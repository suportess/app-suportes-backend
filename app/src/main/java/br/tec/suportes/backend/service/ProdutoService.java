...
public class ProdutoService {
    ...
    public PagedResponse<ProdutoDTO> listar(String auth0Sub, String nmProduto, int page, int pageSize) {
        var c = resolveCreds(auth0Sub);
        return portalClient.listarProdutos(c.host(), c.apikey(), nmProduto, page, pageSize);
    }
